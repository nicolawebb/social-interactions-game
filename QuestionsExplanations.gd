...
As you know, you're here to solve a murder.
You will need to talk to the fellow townspeople 
to find out what they know.

When the timer runs out,
you need to tell who you think is the criminal:
make sure you pay attention!""", "Next"],

["""
You can navigate the arena using the arrow keys.

When you approach a character, you may ask them 
a question by clicking on them.

You can choose to ask the question while being 
happy, angry or sad: choose wisely to get the 
answers you need!""", "Next"],

["""
If you get stuck during the game, click the help 
button in the corner of the screen to be reminded 
of your objective and an overview of the game controls. 
